...
export const majorProjects = [
    {
        ...
        showMore: 'As a main programmer for this experience, I have done much work on the backend and UI. Some large features of this game I developed: anti-cheat (quite strong because of my exploiting experience), product gifting, ranked play, emotes, shop. To name a few smaller areas I developed: leaderboard, inventory, data saving. To allow for moderators to easily take action against players in-game, I also created a Discord bot that can communicate instantly to game servers with Roblox\'s Open Cloud API to deploy bans and similar data modifications in real-time.',
    ...
    },
    {
        ...
        showMore: 'This project accelerated my involvement in Roblox. It received a lot of positive attention from the exploiting community and I kept working to improve it. I did multiple UI updates until I was finally satisfied with the final UI that Owl Hub ended on as it was nice to see and easy to use. Continuous updates to fix features and bypass anti cheat detections were made on many of the games Owl Hub supported. In the end, Owl Hub supported over 40 games.',
        icon: OHLogo,
        banner: OHBanner,
    },
];
