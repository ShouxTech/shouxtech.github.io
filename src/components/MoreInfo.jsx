...
function MoreInfo(props) {
    return (
        <div className="fixed z-50 left-0 top-0 w-full h-full overflow-hidden bg-black/60" onClick={() => props.setMoreInfo(undefined)}>
            <div className="lg:w-[35%] w-[60%] pb-12 bg-zinc-700 rounded overflow-hidden shadow-lg absolute left-1/2 top-1/2 [transform:translate(-50%,-50%)]" onClick={(e) => e.stopPropagation()}>
                {/* Banner is 384x128 */}
                <div className="grid">
