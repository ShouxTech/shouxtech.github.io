        ...
        <div>
            ...
            <div className="grid m-20 gap-4 grid-cols-[repeat(auto-fill,19rem)] sm:grid-cols-[repeat(auto-fill,24rem)] justify-center">
                {minorProjects.map((project) => (
                    <Project key={project.name} projectName={project.name} year={project.year} desc={project.description} url={project.url} bannerImage={project.banner} icon={project.icon}/>
                ))}
            </div>
        </div>
    )
